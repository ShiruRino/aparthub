...
class Module extends Model
{
     ...
     * @var list<string>
     */
    public const SYSTEM_SLUGS = ['resident-management', 'visitor-management', 'service-request', 'community-management', 'tenant-marketplace', 'package-center', 'billing-finance', 'users', 'modules', 'access', 'roles'];
